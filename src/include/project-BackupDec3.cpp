 ...
 *	is called to read in information from the file and store in
 *	the adjacency matrix. Then the initial partitions are created
 *	and the partitioning algorithm is performed. The results
 *	of the algorithm are then printed out and the file is closed.
